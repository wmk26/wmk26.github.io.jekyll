...
经常被各种缩写弄的云里雾里的，今天无意间中知乎上看到一个问答：[Linux中常用的命令都是哪些单词的缩写？](https://www.zhihu.com/question/49073893)，本来想着以后再看的，拖延症有犯了，不过想着现在也没有什么事情，还是立刻去做了吧。于是将整理了一下其中的答案，以备后用；建议查找的时候直接Ctrl+F；
